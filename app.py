...
def render_home_page():
    ...
    # 底部 - 四个核心维度
    st.markdown("""<div style='margin-top: 60px; padding: 32px 40px; background: linear-gradient(135deg, #fce4ec 0%, #f8bbd0 100%); border-radius: 12px; text-align: center;'><h2 style='font-size: 22px; color: #333; margin: 0 0 24px 0;'>我们将评估<span style='color: #ff6b6b;'>四个核心维度</span></h2><div style='display: flex; justify-content: center; gap: 40px; flex-wrap: wrap;'><div style='text-align: center; min-width: 100px;'><div style='font-size: 15px; font-weight: 600; color: #ff6b6b; margin-bottom: 6px;'>归因风格</div><div style='font-size: 12px; color: #666; line-height: 1.4;'>如何解释失败</div></div><div style='text-align: center; min-width: 100px;'><div style='font-size: 15px; font-weight: 600; color: #52c41a; margin-bottom: 6px;'>自我效能感</div><div style='font-size: 12px; color: #666; line-height: 1.4;'>对自己的信心</div></div><div style='text-align: center; min-width: 100px;'><div style='font-size: 15px; font-weight: 600; color: #faad14; margin-bottom: 6px;'>认知负荷</div><div style='font-size: 12px; color: #666; line-height: 1.4;'>心理压力程度</div></div><div style='text-align: center; min-width: 100px;'><div style='font-size: 15px; font-weight: 600; color: #1890ff; margin-bottom: 6px;'>元认知</div><div style='font-size: 12px; color: #666; line-height: 1.4;'>学习意识能力</div></div></div></div>""", unsafe_allow_html=True)
