...
def render_home_page():
    ...
    # 底部 - 四个核心维度（缩放到 50%）
    st.markdown("""<div style='margin-top: 60px; padding: 24px 32px; background: linear-gradient(135deg, #fce4ec 0%, #f8bbd0 100%); border-radius: 12px; text-align: center; transform: scale(0.5); transform-origin: top center; margin-bottom: -60px;'><h2 style='font-size: 20px; color: #333; margin: 0 0 28px 0;'>我们将评估<span style='color: #ff6b6b;'>四个核心维度</span></h2><div style='display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px;'><div style='background: white; padding: 20px 16px; border-radius: 8px; text-align: center;'><div style='font-size: 14px; font-weight: 600; color: #ff6b6b; margin-bottom: 8px;'>归因风格</div><div style='font-size: 12px; color: #666; line-height: 1.5;'>如何解释失败</div></div><div style='background: white; padding: 20px 16px; border-radius: 8px; text-align: center;'><div style='font-size: 14px; font-weight: 600; color: #52c41a; margin-bottom: 8px;'>自我效能感</div><div style='font-size: 12px; color: #666; line-height: 1.5;'>对自己的信心</div></div><div style='background: white; padding: 20px 16px; border-radius: 8px; text-align: center;'><div style='font-size: 14px; font-weight: 600; color: #faad14; margin-bottom: 8px;'>认知负荷</div><div style='font-size: 12px; color: #666; line-height: 1.5;'>心理压力程度</div></div><div style='background: white; padding: 20px 16px; border-radius: 8px; text-align: center;'><div style='font-size: 14px; font-weight: 600; color: #1890ff; margin-bottom: 8px;'>元认知</div><div style='font-size: 12px; color: #666; line-height: 1.5;'>学习意识能力</div></div></div></div>""", unsafe_allow_html=True)
